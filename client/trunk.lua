...
RegisterNetEvent("batopinventaire:openTrunkInventory")
AddEventHandler(
    "batopinventaire:openTrunkInventory",
...
RegisterNetEvent("batopinventaire:refreshTrunkInventory")
AddEventHandler(
    "batopinventaire:refreshTrunkInventory",
    function(data, blackMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, inventory, weapons)
    end
)
