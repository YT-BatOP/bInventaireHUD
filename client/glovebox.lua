...
RegisterNetEvent("batopinventaire:openGloveboxInventory")
AddEventHandler(
    "batopinventaire:openGloveboxInventory",
...
RegisterNetEvent("batopinventaire:refreshGloveboxInventory")
AddEventHandler(
    "batopinventaire:refreshGloveboxInventory",
    function(data, blackMoney, inventory, weapons)
        setGloveboxInventoryData(data, blackMoney, inventory, weapons)
    end
)
