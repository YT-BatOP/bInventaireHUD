...
RegisterServerEvent("batopinventaire:tradePlayerItem")
AddEventHandler(
	"batopinventaire:tradePlayerItem",
...
RegisterCommand(
	...
	function(source, args, rawCommand)
		if IsPlayerAceAllowed(source, "inventory.openinventory") then
			...
			if targetXPlayer ~= nil then
				TriggerClientEvent("batopinventaire:openPlayerInventory", source, target, targetXPlayer.name)
			else
