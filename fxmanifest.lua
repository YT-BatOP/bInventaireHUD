...
description 'ESX Inventaire HUD Rework BatOP'
...
files {
    ...
    'html/img/*.png', -- Charge toutes les images en .png dans le dossier

   -- 'html/img/bullet.png',
    -- ICONS

    'html/img/items/*.png', -- Charge tout les les icons en .png dans le dossier
--[[
